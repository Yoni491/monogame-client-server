...
namespace GameClient
{
    ...
    public static class SpriteManager
    {
        ...
        static public Dictionary<string, Animation> GetAnimation4x4Dictionary(Texture2D i_texture, GraphicsDevice _graphicsDevice)
        {
            return new Dictionary<string, Animation>()
            {
            { "WalkDown", new Animation(Resize4x4Sprite(i_texture,0,_graphicsDevice), 4) },
            { "WalkLeft", new Animation(Resize4x4Sprite(i_texture,1,_graphicsDevice), 4) },
            { "WalkRight", new Animation(Resize4x4Sprite(i_texture,2,_graphicsDevice), 4) },
            { "WalkUp", new Animation(Resize4x4Sprite(i_texture,3,_graphicsDevice), 4) },
            };
        }
