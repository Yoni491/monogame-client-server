...
namespace GameClient
{
    class GameOverScreen
    {
        ...
        public void Initialize(ContentManager content, GraphicsDevice graphics, ProgressManager progressManager)
        {
            ...
            _restartLevel = new Button(GraphicManager.getRectangleTexture(_buttonWeight, _buttonHeight, Color.White), GraphicManager.GetBasicFont(), _buttonPosition + new Vector2(0, _buttonHeight + 2), Color.Green, Color.Gray, "Restart level");
            _exitToMain = new Button(GraphicManager.getRectangleTexture(130, _buttonHeight, Color.White), GraphicManager.GetBasicFont(), _buttonPosition + new Vector2(0, _buttonHeight * 2 + 2), Color.DarkRed, Color.Gray, "Exit To Menu");
