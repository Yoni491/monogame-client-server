...
namespace GameClient
{
    public class CollisionManager
    {
        ...
        public void Initialize(List<NetworkPlayer> other_players, List<Player> players, List<SimpleEnemy> enemies)
        {
        ...
        static public bool isColidedWithPlayers(Rectangle rectangle, Vector2 velocity, int dmg)
        {
            foreach (Player player in _players)
            {
                ...
                {
                    player._health._health_left -= dmg;
