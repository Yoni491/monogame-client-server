...
namespace GameServer
{
    ...
    public class Simple_Enemy
    {
        ...
        public Simple_Enemy(int id, Vector2 position, float speed, PlayerManager playerManager, ItemManager itemManager, int health, int[] items_drop_list, MeleeWeapon meleeWeapon, Gun gun,PathFinder pathFinder)
        {
            _id = id;
            _position = position;
        ...
        public Simple_Enemy Copy(float scale, Gun gun, MeleeWeapon meleeWeapon)
        {
            ...
            return new Simple_Enemy(_id, _position, _speed, _playerManager, _itemManager, _health._total_health, _items_drop_list, meleeWeapon, gun, PathFindingManager.GetPathFinder());
        }
